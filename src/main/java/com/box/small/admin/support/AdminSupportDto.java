...
public class AdminSupportDto {
	...
	public AdminSupportDto() {}
	
	
	
	public AdminSupportDto(int cat_no, String bo_writerId, String bo_title, String bo_content, String bo_createAt,
			int bo_status) {
		super();
		this.cat_no = cat_no;
	...
	public AdminSupportDto(int bo_no, int cat_no, String bo_writerId, String bo_title, String bo_content, String bo_createAt,
			int bo_status) {
		super();
		this.bo_no = bo_no;
		this.cat_no = cat_no;
