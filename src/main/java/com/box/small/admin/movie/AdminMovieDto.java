...
public class AdminMovieDto {
	...
	public AdminMovieDto(int mo_no, int cat_no, String mo_name, String mo_releaseDate, String mo_endDate, int mo_runningTime,
	...
	public AdminMovieDto(int mo_no, int cat_no, String mo_name, String mo_releaseDate, int mo_runningTime, String mo_status,
