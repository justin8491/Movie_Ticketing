      ...
      <div id="paymentForm" style="display: none;">
         ...
         <div>
            <form id="cardForm">
             ...
             <button onclick="getCardNumber()" style="color:white; background-color:#339af0; padding:10px;  border-radius:3px; margin-top:10px;">카드번호 확인</button>
         </div>
          <!-- 티켓 계산식 -->
           <% 
         ...
         %>
         <h4>비밀번호 <input type="text" name="password" placeholder="4자리를 입력해주세요" style="margin-bottom:10px; margin-top:20px;"></h4>      
         <div>
         <input type="checkbox" name="box" style="margin-bottom:10px;">결제대행 서비스 약관에 모두 동의
         <h4 style="margin-bottom:10px;">전자금융거래 이용약관> 개인정보의 수 및 이용안내> 개인정보 제공 및 위탁안내></h4>
         </div>
         ...
         <form name="check" action="/" method="post" onsubmit="return checkForm()">
            ...
            <button type="submit" value="결제" style="color:white; background-color:#339af0;  padding:10px;">결제</button>
         </form>
      </div>
</div>
