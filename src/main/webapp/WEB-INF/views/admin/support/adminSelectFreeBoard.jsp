						...
						<div class="col-md-6">
							<div class="mb-3">
								<h5 class="card-title text-center" style="font-size: 2.5rem;">
									자유게시판 <span class="text-muted fw-normal ms-2"></span>
								</h5>
								<div class="col-md-6">
									<div
										class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3"></div>
								</div>
							</div>
							<div class="row">
								<div class="col-lg-12">
									<div class="">
										<div class="table-responsive">
											<table
												...
												<thead>
													<tr>
														<th scope="col" class="ps-4" style="width: 10px;">번호
															: ${freeBoard.bo_no}</th>
														<th scope="col" style="width: 1000px;">제목 :
															${freeBoard.bo_title}</th>
