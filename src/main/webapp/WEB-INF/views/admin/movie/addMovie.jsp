            ...
            <div class="page">
                ...
                <div class="content">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form action="/admin/movie/addMovie" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="mo_runningTime" class="form-label">러닝타임 (숫자만 입력해주세요)</label>
                                ...
                                <div class="mb-3">
							        <label for="mo_photo" class="form-label">영화포스터 (포스터사진이 준비되지 않았으면 no_image.jpg 입력)</label>
							        <input type="file" id="mo_image" name="mo_image" class="form-control">
							    </div>
